...
const htmlToInject = `
      ...
      <div hidden id="main" data-layer="Map with the guide and the crab and the fishermen" class="screen light-bg">
        ...
        <img data-layer="Fishermen" class="element" style="width: 250px; height: 181px; left: 1045px; top: 595px;" src="images/fisherman.png" alt="Fishermen" />
      ...
      <div hidden id="fisherman" data-layer="Conversation with the fisherman" class="screen light-bg">
        <img data-layer="Map" class="full-width" src="images/fisherman-background.png" alt="Map" />
      ...
      <div hidden id="crab" data-layer="Conversation with the Crab" class="screen light-bg">
        <img data-layer="Map" class="full-width" src="images/crab-background.png" alt="Map" />
